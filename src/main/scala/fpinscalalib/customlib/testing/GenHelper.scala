...
// The following implementation of the Gen class is provided by Manning as a solution to the multiple implementation
// exercises found in the "Functional Programming in Scala" book. We'll use this one in our sections related to chapter 8:
// "Property-based testing". The original code can be found in the following URL:
//
// https://github.com/fpinscala/fpinscala/blob/b67edde531fb09cb35400ce43c1147974a9d084f/answers/src/main/scala/fpinscala/testing/Gen.scala
...
import fpinscalalib.customlib.functionalparallelism.Par.Par
...
case class SGen[+A](g: Int => Gen[A]) {
  ...
  def flatMap[B](f: A => SGen[B]): SGen[B] = {
    val g2: Int => Gen[B] = n => g(n) flatMap { a => f(a).g(n) }
    SGen(g2)
  }
