...
// The following implementation of the Parsers type (and other associated types) is provided by Manning as a solution to
// the multiple implementation exercises found in the "Functional Programming in Scala" book. We'll use these in our
// sections related to chapter 9: "Parser combinators". The original code can be found in the following URL:
//
// https://github.com/fpinscala/fpinscala/blob/44e01a7b5cc68cd681f182274b3a605db1bcff6c/answers/src/main/scala/fpinscala/parsing/Parsers.scala
...
case class ParseError(stack: List[(Location, String)] = List()) {
  ...
  override def toString =
    if (stack.isEmpty) "no error message"
      ...
      collapsed
        .map { case (loc, msg) => loc.line.toString + "." + loc.col + " " + msg }
        .mkString("\n") +
        context
    }
