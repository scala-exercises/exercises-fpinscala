...
// The following implementation of the State monad is provided by Manning as a solution to the implementation
// exercises found in the "Functional Programming in Scala" book. We'll use this one (instead of Scala's State), in our
// sections related to chapter 6: "Purely Functional State". The original code can be found in the following URL:
//
