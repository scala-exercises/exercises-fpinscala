...
// The following implementation of the NonBlocking type is provided by Manning as a solution to the multiple implementation
// exercises found in the "Functional Programming in Scala" book. We'll use this type, in our sections related to
// chapter 7: "Purely Functional Parallelism". The original code can be found in the following URL:
//
// https://github.com/fpinscala/fpinscala/blob/44e01a7b5cc68cd681f182274b3a605db1bcff6c/answers/src/main/scala/fpinscala/parallelism/Nonblocking.scala
