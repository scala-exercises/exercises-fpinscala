...
// The following implementation of the lazy list (Stream) is provided by Manning as a solution to the implementation
// exercises found in the "Functional Programming in Scala" book. We'll use this one (instead of Scala's Streams), in our
// sections related to chapter 5: "Strictness and laziness". The original code can be found in the following URL:
//
// https://github.com/fpinscala/fpinscala/blob/6b1c6f2b0836f6d307ecdc0a7a397c30fc64749e/answers/src/main/scala/fpinscala/laziness/Stream.scala
