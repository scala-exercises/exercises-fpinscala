 ...
 */
object GettingStartedWithFPSectionZ
    extends AnyFlatSpec
    with Matchers
  ...
  def fibAssert(res0: Int) = {
    @annotation.tailrec
    // move this function out to be more readable
    // think of n as how many steps needs "to go"
    ...
    fib(0) should be(0) // initial prev
    fib(1) should be(1) // initial cur
    // above are both special / base cases
    fib(2) should be(1)
    fib(3) should be(2)
    fib(4) should be(3)
    fib(5) should be(5)
